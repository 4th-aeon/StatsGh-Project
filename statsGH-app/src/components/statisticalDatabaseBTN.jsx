...
const StatsDatabaseBTN = () => {
  return (
    <div>
      <div>
        <Link to="/">
          <button className="w-[200px] h-[35px] gap-3 justify-center items-center text-black font-goudos bg-[#ffdd00] rounded-[60px]  flex ">
...
export default StatsDatabaseBTN;
